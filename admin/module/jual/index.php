...
?>
	...
	<div class="row">
		<div class="col-sm-4">
			<div class="card card-primary mb-3">
				<div class="card-header bg-primary text-white">
					<h5><i class="fa fa-search"></i> Search For Items</h5>
				</div>
				<div class="card-body">
		...
		<div class="col-sm-8">
			<div class="card card-primary mb-3">
				<div class="card-header bg-primary text-white">
					<h5><i class="fa fa-list"></i> Search Result</h5>
				</div>
				<div class="card-body">
		...
		<div class="col-sm-12">
			<div class="card card-primary">
				<div class="card-header bg-primary text-white">
					<h5><i class="fa fa-shopping-cart"></i> Kasir Isnain
						...
						<table class="table table-stripped">
							...
							<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
								...
								<tr>
									...
									<td><button class="btn btn-success"><i class="fa fa-shopping-cart"></i> Pay</button>
							...
							<tr>
								...
								<td>
									...
									<button class="btn btn-secondary">
										<i class="fa fa-print"></i> Print Proof of Payment
									</button></a>
								</td>
							</tr>
						</table>
