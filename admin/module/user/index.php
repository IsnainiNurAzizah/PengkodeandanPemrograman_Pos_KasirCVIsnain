...
<div class="row">
	<div class="col-sm-3">
		<div class="card card-primary">
			<div class="card-header">
				<h5 class="mt-2"><i class="fa fa-user"></i> User Photo </h5>
			</div>
			<div class="card-body">
	...
	<div class="col-sm-5">
		<div class="card card-primary">
			<div class="card-header">
				<h5 class="mt-2"><i class="fa fa-user"></i> Manage User </h5>
			</div>
			<div class="card-body">
					...
					<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?profil=edit"
						...
						<fieldset>
							...
							<button class="btn btn-primary" name="btn" value="Tambah">
								<i class="fas fa-edit"></i> Change Profil
							</button>
						</fieldset>
					</form>
				</div>
	...
	<div class="col-sm-4">
		<div class="card card-primary">
			<div class="card-header">
				<h5 class="mt-2"><i class="fa fa-lock"></i> Change Password</h5>
			</div>
			<div class="card-body">
				<div class="box-content">
					<form class="form-horizontal" method="POST" action="fungsi/edit/edit.php?pass=ganti-pas">
						<fieldset>
							...
							<button type="submit" class="btn btn-primary" value="Tambah" name="proses"><i class="fas fa-edit"></i> Change Password</button>
						</fieldset>
					</form>
				</div>
			</div>
